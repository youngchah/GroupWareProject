<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div class="row">
	<div class="col-sm-3 col-xl-2 h-100">
		<!-- 사원 정보 -->
		<div class="card rounded-3 bg-primary h-100 w-100">
			<div class="card-body rounded-3 p-3 text-white">
				<div class="d-flex align-items-center justify-content-center">
					<img class="w-50 rounded-circle" src="${pageContext.request.contextPath }/resources/vendor/images/profile/user-1.jpg">
				</div>
				<div class="card-body text-center p-3">
					<div class="d-inline">
						<span class="h3 text-white">김사원</span>
						<span class="ms-2">사원</span>
						<p class="m-0">개발본부</p>
						<p class="m-0">202411223</p>
					</div>
				</div>
				<div class="">

							...
							<div class="d-flex align-items-center">
								<div class="col-6">
									<div>
										...
										<span>&nbsp;&nbsp;휴지통 ${pagingVO.totalRecord } / 안읽은메일 ${noRead }</span>
									</div>
								</div>
								<div class="col-6">
						...
						<div class="container-fluid" style="margin-left: 12px;">
							<div class="collapse navbar-collapse justify-content-between" id="collapsibleNavbar">
								<ul class="navbar-nav">
									...
									<li class="nav-item">
										<span id="clear">
											<label for="clear" style="cursor: pointer;"><i class="ti ti-trash fs-5 me-1"></i>영구삭제 
										</span>
										</label>
									</li>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<li class="nav-item">
										<span id="recover">
											<label for="recover" style="cursor: pointer;"><i class="ti ti-inbox fs-5 me-1"></i>되돌리기 
										</span>
										</label>
									</li>
								</ul>
...
clear.on("click", function() { 
	...
	showConfirm("휴지통의 메일을 지우면 지워진 메일들은 복구할 수 없습니다.\n"+selectedValues.length+"개의 메일을 영구삭제하시겠습니까?",'','question').then(result=> {

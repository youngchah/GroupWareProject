					...
					<div class="px-4 pt-9 pb-6 d-none d-lg-block">
						<form id="searchForm">
							...
							<div class="d-flex align-items-center">
								<div class="col-6">
									<div>
										<span class="fs-5 fw-semibold"><i class="ti ti-star fs-5"></i> 중요메일함</span> <span>&nbsp;&nbsp;중요메일 ${pagingVO.totalRecord } / 안읽은메일 ${noRead }</span>
									</div>
								</div>
								<div class="col-6">
						...
						<div class="container-fluid" style="margin-left: 12px;">
							<div class="collapse navbar-collapse justify-content-between" id="collapsibleNavbar">
								<ul class="navbar-nav">
									...
									<li class="nav-item"><span id="important"><label for="important" style="cursor: pointer;"><i class="ti ti-star fs-5 me-1"></i>중요하지 않음</span></label></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<li class="nav-item"><span id="read"><label for="read" style="cursor: pointer;"><i class="ti ti-inbox fs-5 me-1"></i>읽음처리</span></label></li>
								</ul>
							</div>
						</div>
					</nav>
									...
									<c:forEach items="${emailList }" var="email">
										<li id="${email.emailNo }"><a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_3" data-user-id="3">
												<div class="form-check mb-0">
													...
													<c:choose>
														<c:when test="${email.senderNo eq user.emplNo }">
															<!-- 보낸메일 -->

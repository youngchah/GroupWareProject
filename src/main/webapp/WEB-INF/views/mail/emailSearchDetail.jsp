							...
							<div class="d-flex align-items-center">
								<div class="col-6">
									<div>
										...
										<span>&nbsp;&nbsp; ${pagingVO.totalRecord }</span>
									</div>
								</div>
								<div class="col-6">
								...
								<div class="modal-body">
									<form id="searchDetailForm" action="/mail/searchDetail" method="get">
										...
										<div class="mb-3 row">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" id="searchSender" name="searchSender" value="${searchSender }">
											</div>
										</div>
										<div class="mb-3 row">
											<label for="recipient-name" class="col-sm-3 col-form-label text-center" style="font-weight: lighter; font-size: 15px;">받는 사람</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="searchReceiver" name="searchReceiver" value="${searchReceiver }">
											</div>
										</div>
										<div class="mb-3 row">
										...
										<div class="mb-3 row">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" id="searchContent" name="searchContent" value="${searchContent }">
											</div>
										</div>
										<div class="mb-3 row">
											<label for="recipient-name" class="col-sm-3 col-form-label text-center" style="font-weight: lighter; font-size: 15px;">첨부파일명</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="searchAttach" name="searchAttach" value="${searchAttach }">
											</div>
										</div>
										<sec:csrfInput />
									</form>
						...
						<div class="container-fluid" style="margin-left: 12px;">
							<div class="collapse navbar-collapse justify-content-between" id="collapsibleNavbar">
								<ul class="navbar-nav">
									...
									<li class="nav-item">
										<span id="read">
											<label for="read" style="cursor: pointer;"><i class="ti ti-inbox fs-5"></i>읽음처리 
										</span>
										</label>
									</li>
								</ul>
									...
									<li>
										<a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_3" data-user-id="3">
											...
											<div class="position-relative w-100 ms-2 text-center">
												...
												<h6 class="text-dark">검색 결과가 없습니다.</h6>
...
$(function(){
	var searchForm = $("#searchDetailForm");

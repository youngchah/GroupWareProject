					...
					<div class="px-4 pt-9 pb-6 d-none d-lg-block">
						<form id="searchForm">
							...
							<div class="d-flex align-items-center">
								<div class="col-6">
									<div>
										<span class="fs-5 fw-semibold"><i class="ti ti-file-text fs-5"></i> 임시보관함</span> <span>&nbsp;&nbsp;임시보관메일 ${pagingVO.totalRecord }</span>
									</div>
								</div>
								<div class="col-6">
						...
						<div class="container-fluid" style="margin-left: 12px;">
							<div class="collapse navbar-collapse justify-content-between" id="collapsibleNavbar">
								<ul class="navbar-nav">
									...
									<li class="nav-item"><span id="trash" class="me-1" style="cursor: pointer;"><i class="ti ti-trash fs-5 me-1" style="cursor: pointer;"></i>삭제</span></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<li class="nav-item"><span id="important" style="cursor: pointer;"><i class="ti ti-star fs-5 me-1" style="cursor: pointer;"></i>중요</span></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</ul>
							</div>
						</div>
					</nav>
									...
									<c:forEach items="${emailList }" var="email">
										<li id="${email.emailNo }"><a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_3" data-user-id="3">
												...
												<div class="position-relative w-100 ms-2">
													<div class="d-flex align-items-center justify-content-between mb-2">
														<c:choose>
															<c:when test="${empty email.employeeVO}">
																<h6 class="text-dark">(받는이없음)</h6>
															</c:when>
															<c:otherwise>
													...
													<h6 class="mb-0" onclick="location.href='/mail/draftDetail?emailNo=${email.emailNo }'">${email.emailNm }

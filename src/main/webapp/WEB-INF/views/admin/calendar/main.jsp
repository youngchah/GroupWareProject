...
<div class="schedul-page-box row">
	<div class="col-yen-10 cal-nav mt-0" style="width: 12% !important;">
		...
		<div class="nav flex-column nav-pills mb-4 mb-md-0" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			...
			<br/>
			<a class="nav-link active" id="v-pills-company-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="true"> 
				사내 일정 </a>
		</div>
	</div>
	...
	<div id="schedule-detail-info" class="card-body col-yen-30">
		...
		<form action="/admin/schedule/modify" method="get" id="modForm" >
			<sec:csrfInput/>
...
<script src="${pageContext.request.contextPath }/resources/project/js/admin/calendar/calendar_main.js"></script>
